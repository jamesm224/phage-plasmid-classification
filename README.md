...
The files in this repository contain code and smaller data files. If you want additional information, please reach out to James Mullet for further information/questions (jmullet@umich.edu). Additionally, genomes and other metadata can be found on Figshare located here: [[https://figshare.com/s/b0ffbc71c0bf43e251df](https://doi.org/10.6084/m9.figshare.c.7276789)]
