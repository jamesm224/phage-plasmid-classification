...
<img width="4029" height="2124" alt="figure_1" src="https://github.com/user-attachments/assets/7bcf1301-d1f6-4ee9-807f-f79fcba7193c" />


# Source Code

The files in this repository contain code and smaller data files. If you want additional information, please reach out to James Mullet for further information/questions (jmullet@umich.edu). Additionally, genomes and other metadata can be found on Figshare located here: 
[https://doi.org/10.6084/m9.figshare.c.7276789] (https://doi.org/10.6084/m9.figshare.c.7276789)
